...
class DilucWidget extends StatelessWidget {
  const DilucWidget({Key? key}) : super(key: key);
            ...
            children: [
              Column(
                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Image.asset(
                              'assets/characters_full/Diluc.png',
                              width: MediaQuery.of(context).size.width,
                              height: 700,
                              fit: BoxFit.cover,
                            ),
                  ...
                  Image.network(
                    'https://i.pinimg.com/736x/ac/24/f4/ac24f441dda20f536bf7e8d2cde35fa1.jpg',
                    width: 450,
                    height: 270,
                    fit: BoxFit.cover,
                  )
