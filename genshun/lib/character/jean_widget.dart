...
class JeanWidget extends StatelessWidget {
  const JeanWidget({Key? key}) : super(key: key);
            ...
            children: [
              Column(
                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: const BoxDecoration(
                          color: Color(0xFFC4E7B5),
                        ),
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            Image.asset(
                              'assets/characters_full/Jean.png',
                              width: MediaQuery.of(context).size.width,
                              height: 700,
                              fit: BoxFit.cover,
                            ),
                  ...
                  Image.network(
                    'https://i.pinimg.com/1200x/06/43/17/064317e356f22dd5670c8c7eadcf0342.jpg',
                    width: 450,
                    height: 270,
                    fit: BoxFit.cover,
                  )
