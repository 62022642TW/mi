...
class NoelleWidget extends StatelessWidget {
  const NoelleWidget({Key? key}) : super(key: key);
            ...
            children: [
              Column(
                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: const BoxDecoration(
                          color: Color(0xFF58490C),
                        ),
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            Image.asset(
                              'assets/characters_full/Noelle.png',
                              width: MediaQuery.of(context).size.width,
                              height: 700,
                              fit: BoxFit.cover,
                            ),
                  ...
                  Image.network(
                    'https://i.pinimg.com/originals/57/ff/27/57ff277639ee5301f996a752f7f8cbde.jpg',
                    width: 450,
                    height: 270,
                    fit: BoxFit.cover,
                  )
